...
from .views import log_view as lv, instructor_view as iv, participant_view as pv, hr_view as hv, administrator_view as av, pressure_test as pt
urlpatterns = [
    url(r'^$', lv.login, name='login'),
    url(r'^loaderio-6665d5b76e0dd29d31d695e1d5796704.txt', pt.test, name='pressure_test'),
    url(r'^loaderio-6665d5b76e0dd29d31d695e1d5796704.html', pt.test, name='pressure_test'),
    url(r'^loaderio-6665d5b76e0dd29d31d695e1d5796704', pt.test, name='pressure_test'),
