...
urlpatterns = [
    ...
    url(r'^registration/', lv.participant_registration,
    ...
    url(r'^instructor/', include([
        ...
        url(r'^course/', include([
            url(r'^create/', include([
                url(r'^finish/', iv.finish_create_course,
                    name='instructor_finish_create_course'),
                url(r'^start/', iv.create_course,
        ...
        url(r'^module/', include([
            url(r'^create/', include([
                url(r'^finish/', iv.finish_create_module,
                    name='instructor_finish_create_module'),
                url(r'^start/', iv.create_module,
                    name='instructor_create_module'),
            ])),
            url(r'^moveup/', iv.moveup_module, name='instructor_moveup_module'),
            url(r'^movedown/', iv.movedown_module,
                name='instructor_movedown_module'),
            url(r'^delete/', iv.delete_module, name='instructor_delete_module'),
        ])),
        url(r'^component/', include([
            url(r'^create/', include([
                url(r'^finish/', iv.finish_create_component,
                    name='instructor_finish_create_component'),
                url(r'^start/', iv.create_component,
                    name='instructor_create_component'),
                url(r'^upload/', iv.file_upload, name='instructor_file_upload'),

            ])),
            url(r'^download/', iv.file_download,
                name='instructor_file_download'),
            url(r'^delete/', iv.delete_component,
                name='instructor_delete_component'),
            url(r'^moveup/', iv.moveup_component,
                name='instructor_moveup_component'),
            url(r'^movedown/', iv.movedown_component,
                name='instructor_movedown_component'),
        ])),
    ])),
    ...
    url(r'^participant/', include([
        ...
        url(r'^course/', include([
            url(r'^finish/', include([
                url(r'^component/', pv.finish_component,
                    name='participant_finish_component'),
            ])),
        ...
        url(r'^component/', include([
            url(r'^download/', pv.file_download,
                name='participant_file_download'),
        ])),
    ])),
    ...
    url(r'^administrator/', include([
        url(r'^category/', include([
            ...
            url(r'^create/', av.category_create,
                name='administrator_create_category'),
            url(r'^createFinish/', av.category_create_finish,
                name='administrator_create_finish'),
            url(r'^delete/', av.category_delete,
                name='administrator_delete_category'),
        ])),
        url(r'^priority/', include([
            ...
            url(r'^generate_by_name/', av.generate_by_name,
                name='administrator_generate_by_name'),
        ])),
    ])),
]
